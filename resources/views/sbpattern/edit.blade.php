        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body row g-3 form-group">
                    <form action="{{ route('sbpattern.update', $row->id) }}" method="POST">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="">
                            <input class="form-check-input" type="radio" name="in_status" value="1" {{$row->status ==
                            'Tersedia'? 'checked' : ''}}> <label class="form-check-label">Tersedia</label>
                            <input class="form-check-input" type="radio" name="in_status" value="0" {{$row->status ==
                            'Tidak Tersedia'? 'checked' : ''}}> <label class="form-check-label">Tidak Tersedia</label>
                        </div>
