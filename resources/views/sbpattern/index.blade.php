                ...
                <div class="card-header">
                    <form class="form-inline">
                        ...
                        <div class="input-group mr-1">
                            ...
                            <a class="btn btn-primary" href="{{ route('sbpattern.create') }}"><i
                                    class="bi bi-plus-lg"></i> Tambah Pola Sleeping Bag</a>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ route('sbpattern.destroy', $row) }}"
